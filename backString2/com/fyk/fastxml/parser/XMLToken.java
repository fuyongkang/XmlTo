...
public class XMLToken {
    ...
    //
    public final static int LBRACE_XML           = 22; // ("<"),
    //
    public final static int RBRACE_XML           = 23; // (">"),
    public final static int RENDING_XML          = 24; // ("/>"   "/ sdf>"),
    public final static int COLON_XML            = 27; // ("="),
    public final static int QUIT_XML             = 28; // ("/"),
    
    //
    public final static int IDENTIFIER           = 30;
    //
    public final static int FIELD_NAME           = 31;

    public final static int EOF                  = 32;

    public final static int SET                  = 33;
    public final static int TREE_SET             = 34;
