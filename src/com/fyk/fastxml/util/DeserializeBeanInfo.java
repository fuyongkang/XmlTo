...
import com.fyk.fastxml.annotation.XMLCreator;
...
public class DeserializeBeanInfo {
        ...
        if (defaultConstructor != null) {
            ...
            if (creatorConstructor != null) {
                ...
                for (int i = 0; i < creatorConstructor.getParameterTypes().length; ++i) {
                    ...
                    XMLField fieldAnnotation = null;
                    for (Annotation paramAnnotation : paramAnnotations) {
                        if (paramAnnotation instanceof XMLField) {
                            fieldAnnotation = (XMLField) paramAnnotation;
                            break;
                        }
                    }
                    if (fieldAnnotation == null) {
                        throw new XMLException("illegal json creator");
                    }
            ...
            throw new XMLException("default constructor not found. " + clazz);
        }
    ...
    public static Constructor<?> getCreatorConstructor(Class<?> clazz) {
        ...
        for (Constructor<?> constructor : clazz.getDeclaredConstructors()) {
        	XMLCreator annotation = constructor.getAnnotation(XMLCreator.class);
            if (annotation != null) {
                if (creatorConstructor != null) {
                    throw new XMLException("multi-json creator");
                }
    ...
    public static Method getFactoryMethod(Class<?> clazz) {
        ...
        for (Method method : clazz.getDeclaredMethods()) {
            ...
            XMLCreator annotation = method.getAnnotation(XMLCreator.class);
            if (annotation != null) {
                if (factoryMethod != null) {
                    throw new XMLException("multi-json creator");
                }
