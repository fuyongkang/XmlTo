...
import static com.fyk.fastxml.util.TypeUtils.castToString;
 ...
 */
public class XMLArray extends XML implements List<Object>, XMLAware, Cloneable, RandomAccess, Serializable {
    ...
    public XMLArray(List<Object> list){
        this.list = list;
    }

    public XMLArray(int initialCapacity){
    ...
    public Object clone() {
        return new XMLArray(new ArrayList<Object>(list));
    }
